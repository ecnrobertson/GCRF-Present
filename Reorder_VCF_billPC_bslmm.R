...
zf_ified %>% 
  ...
  write_delim("~/Desktop/GCRF/GCRF-Present/GenomicPipeline/data/bslmm/GCRF_billPC_clean.SNP.rm_hets.RegionFID.imuted_gt.fix_name.noNA.chr1-31ZF.genotype.txt", quote = "none" ,delim = "\t")
