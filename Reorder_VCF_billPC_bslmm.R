...
combo <- full_join(scaffs, vcf, by = "CHROM")
tail(combo)
...
#zf_ified %>% 
#  write_delim("~/Desktop/GCRF/GCRF-Present/GenomicPipeline/data/bslmm/GCRF_billPC_clean.negs.chr1-31ZF.genotype.params.txt", quote = "none" ,delim = "\t")
...
library(pgirmess)
zf_ified %>% 
  write_delim("~/Desktop/GCRF/GCRF-Present/GenomicPipeline/data/bslmm/GCRF_billPC_clean.chr1-31ZF.genotype.params.txt", quote = "none" ,delim = "\t")
